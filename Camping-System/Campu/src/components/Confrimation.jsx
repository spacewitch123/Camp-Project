...
function Confirmation() {
    ...
    // Calculate total price based on the number of units
    const totalPrice = camp.price * formData.units;
    ...
    const handleProceedToPayment = () => {
        ...
        navigate('/payment', { state: { formData, camp } });
    };
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="min-h-screen bg-gray-100 p-6 flex justify-center items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full"> {/* Grid for responsiveness */}
                    <div className="bg-white p-8 rounded-lg shadow-md">
                        <h2 className="text-2xl font-bold mb-6">Confirmation</h2>
                        <div className="space-y-3"> {/* Add vertical spacing */}
